...
// Real ingested data (gitignored, generated by scripts/ingest-extratos.mjs).
// goals, netWorthByMonth, positions still come from mock until those modules
// have ingestion paths (M5: Pluggy will replace).
import { accounts, transactions } from "@/lib/data/imported";
import { goals, netWorthByMonth, positions } from "@/lib/mock/data";
