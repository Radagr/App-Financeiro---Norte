...
export const accounts: Account[] = [
  { id: "acc_1", name: "Itaú Corrente",   bank: "Itaú",   kind: "checking",   balance:   8420.55, color: "chart-1" },
  { id: "acc_2", name: "Nubank Cartão",   bank: "Nubank", kind: "credit",     balance:  -3210.40, color: "chart-2" },
  { id: "acc_3", name: "Inter PJ",         bank: "Inter",  kind: "checking",   balance:  12340.00, color: "chart-3" },
  { id: "acc_4", name: "Caixa FGTS",       bank: "Caixa",  kind: "savings",    balance:  18750.20, color: "chart-4" },
  { id: "acc_5", name: "Rico Tesouro",     bank: "Rico",   kind: "investment", balance:  45200.00, color: "chart-1" },
  { id: "acc_6", name: "BTG FII",          bank: "BTG",    kind: "investment", balance:  28100.50, color: "chart-2" },
  { id: "acc_7", name: "Binance Cripto",   bank: "Binance",kind: "investment", balance:   7890.30, color: "chart-5" },
];

export const positions: InvestmentPosition[] = [
  { id: "pos_1", ticker: "TESOURO IPCA+ 2035",      assetClass: "rf",     currentValue: 32400, costBasis: 28000 },
...
export function periodToDateRange(period: Period, now: Date = new Date()): {
  start: Date;
  end: Date;
} {
...
describe("computeSaldoConsolidado", () => {
  ...
  it("returns breakdown grouped by bank", () => {
    const result = computeSaldoConsolidado(accounts);
    expect(result.byBank).toContainEqual(
      expect.objectContaining({ bank: "Itaú", total: 8420.55 }),
    );
    expect(result.byBank).toContainEqual(
      expect.objectContaining({ bank: "Inter", total: 12340 }),
    );
  });
    ...
    <ModuleCard title="Saldo consolidado" subtitle="Patrimônio líquido total">
      <div className="space-y-4">
        <div className="space-y-1">
          <p className="font-mono tabular text-norte-primary text-4xl font-semibold tracking-tight dark:text-white">
        ...
        <ul className="border-border divide-border divide-y border-t pt-3">
          {saldo.byBank.map((b) => (
            ...
            >
              ...
              <span className="font-mono tabular">{BRL_PRECISE.format(b.total)}</span>
            </li>
          ))}
        </ul>
      </div>
          ...
          return (
            <li key={g.id} className="space-y-2">
              <div className="flex items-baseline justify-between gap-3">
                ...
                <p className="font-mono tabular text-xs">
...
function FluxoTooltip({
  ...
  return (
    <div className="border-border bg-popover text-popover-foreground rounded-md border px-3 py-2 text-xs shadow-card">
      ...
      <div className="h-56">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 8, right: 4, bottom: 0, left: -16 }}>
            ...
            />
            <Tooltip content={<FluxoTooltip />} cursor={{ fill: "hsl(var(--muted))", opacity: 0.4 }} />
...
function PatrimonioTooltip({
  ...
  return (
    <div className="border-border bg-popover text-popover-foreground rounded-md border px-3 py-2 text-xs shadow-card">
      ...
      <p className="font-mono tabular mt-0.5 font-semibold">{BRL.format(point.value)}</p>
    </div>
  );
}
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 8, right: 4, bottom: 0, left: -16 }}>
            ...
            <YAxis
              ...
              tickFormatter={(v: number) => BRL.format(v).replace("R$", "").trim()}
            />
            <Tooltip content={<PatrimonioTooltip />} cursor={{ stroke: "hsl(var(--muted-foreground))", strokeOpacity: 0.4 }} />
            <Area
              type="monotone"
              dataKey="netWorth"
